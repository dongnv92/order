...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 16, 2019 lúc 05:51 AM
...
(9, 'EJKGB', 'Nguyễn Văn Đông', '966624292', 'Do Hạ, Tiền Phong, Mê Linh, Hà Nội', '', 1, 0, 1459500, 1, '2019-03-16 10:56:14', NULL, NULL, NULL, '2019-03-16 10:55:18'),
...
--
ALTER TABLE `dong_bill_product`
  MODIFY `bill_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `dong_media`
  MODIFY `media_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;
