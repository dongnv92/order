...
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/jquery.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/tether.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/bootstrap.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/jquery-migrate.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/hidemaxlistitem.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/hidemaxlistitem.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/jquery.easing.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/scrollup.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/jquery.waypoints.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/waypoints-sticky.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/pace.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/slick.min.js"></script>
<script type="text/javascript" src="<?=_URL_HOME?>/assets/js/scripts.js"></script>
