...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/bootstrap.min.css">

    <!-- Customizable CSS -->
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/main.css">
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/blue.css">
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/owl.carousel.css">
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/owl.transitions.css">
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/animate.min.css">
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/rateit.css">
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/bootstrap-select.min.css">
    <link href="<?=_URL_HOME?>/assets/css/lightbox.css" rel="stylesheet">



    <!-- Icons/Glyphs -->
    <link rel="stylesheet" href="<?=_URL_HOME?>/assets/css/font-awesome.css">
            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#"><i class="icon fa fa-heart"></i>Wishlist</a>
                        </li>
                        <li><a href="#"><i class="icon fa fa-shopping-cart"></i>My Cart</a>
                        </li>
                                ...
                                <ul class="categories-filter animate-dropdown">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Shoes</a>
                                            </li>
                                            <li role="presentation"><a role="menuitem" tabindex="-1" href="category.html">- Watches</a>
                                            </li>
                    ...
                    <div class="dropdown dropdown-cart">
                        <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
                            <div class="items-cart-inner">
                                ...
                                <div class="basket-item-count"><span class="count">2</span>
                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            ...
                                                            <li><a href="#">School Bags</a>
                                                            </li>
                                                            <li><a href="#">Lunch Box</a>
                                                            </li>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            ...
                                                            <li><a href="#">Adapters</a>
                                                            </li>
                                                            <li><a href="#">Batteries</a>
                                                            </li>
                                                            <li><a href="#">Cooling Pads</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <!-- /.col -->
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            <li><a href="#">Routers & Modems</a>
                                                            </li>
                                                            <li><a href="#">CPUs, Processors</a>
                                                            </li>
                                                            <li><a href="#">PC Gaming Store</a>
                                                            </li>
                                                            <li><a href="#">Graphics Cards</a>
                                                            </li>
                                                            <li><a href="#">Components</a>
                                                            </li>
                                                            <li><a href="#">Webcam</a>
                                                            </li>
                                                            <li><a href="#">Memory (RAM)</a>
                                                            </li>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            ...
                                                            <li><a href="#">Binoculars</a>
                                                            </li>
                                                            <li><a href="#">Telescopes</a>
                                                            </li>
                                                            <li><a href="#">Camcorders</a>
                                                            </li>
                                                            <li><a href="#">Digital</a>
                                                            </li>
                                                            <li><a href="#">Film Cameras</a>
                                                            </li>
                                                            <li><a href="#">Flashes</a>
                                                            </li>
                                                            <li><a href="#">Lenses</a>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-4 col-menu custom-banner">
                                                        <a href="#"><img alt="" src="assets/images/banners/banner-side.png">
                                                        </a>
                                                    </div>
                                                </div>
                                                <!-- /.row -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-menu">
                                                        <ul class="links">
                                                            ...
                                                            <li><a href="track-orders.html">Track Orders</a>
                                                            </li>
